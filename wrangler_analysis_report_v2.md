...
- Status counts: Unclear 1, Hallucinated 1, Deviation-Skipped 8
...
| 2 | Validate that the homepage loads successfully and ... | Hallucinated | 70% | Log claims step was executed but no visual evidence found. | - |
| 3 | Locate and click on the Search icon to activate th... | Deviation-Skipped | 95% | Test terminated early; step was never executed. | - |
