...
Scenario:Search for black running shoes, verify size 10 availability, and add to cartSearch for black running shoes, verify size 10 availability, and add to cart
